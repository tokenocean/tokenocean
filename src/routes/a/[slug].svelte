  ...
  <div class="flex flex-wrap">
    <div class="lg:text-left w-full lg:w-1/3 lg:max-w-xs">
        ...
        {#if artwork.is_physical}
          ...
          >
            ...
            <div class="my-auto mb-1">
              <span class="text-sm text-offblack">Physical artwork</span>
            </div>
          </div>
        {/if}
      </div>
      ...
      {#if artwork.description}
        <div
          class="mob-desc description text-white whitespace-pre-wrap break-words"
        >
    ...
    <div class="w-full lg:w-2/3 lg:pl-40">
      ...
      {#if artwork.description}
        <div class="desk-desc description text-white break-words">
